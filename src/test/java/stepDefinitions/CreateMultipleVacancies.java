...
public class CreateMultipleVacancies {
	...
	public void fillAddJobVacancyForm(String vacancyName) {
		...
		driver.findElement(By.id("addJobVacancy_name")).sendKeys(vacancyName+Math.round(d));
	...
	public void verifyVacancyCreation(String vacancyName) {
		...
		System.out.println(vacancySearch_jobVacancy);
		Select selectJobVacancy = new Select(vacancySearch_jobVacancy);
		selectJobVacancy.selectByVisibleText(vacancyName+Math.round(d));
		...
		String actualVacancyName = driver.findElement(By.linkText(vacancyName+Math.round(d))).getText();
		Assert.assertEquals(actualVacancyName, vacancyName+Math.round(d));
		System.out.println("Vacancy is created");
	}
